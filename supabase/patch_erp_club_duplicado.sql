-- ============================================================================
-- FIX: importar del ERP fallaba con "Ya existe un club con ese nombre" cuando
-- el ERP tiene dos clubes distintos con el MISMO nombre (o el club de la marca
-- ya quedó vinculado a otro registro ERP). Regla: el club es único POR MARCA →
-- si existe un club con ese nombre, se USA (vinculado o no), nunca se duplica.
...
begin
  ...
  loop
    ...
    if v_club is not null then
      ...
      --    Si aún no tiene vínculo ERP, se adopta; si ya está vinculado a otro
      --    registro del ERP (duplicado en el ERP), se reusa sin tocar el vínculo.
