-- ============================================================================
-- PERFIL: dashboard de participación — se agrega 'duracion' (minutos del
-- partido de la categoría; hereda del torneo, default 90) a cada entrada
-- de 'torneos' en perfil_publico. Única diferencia con la versión vigente.
-- ============================================================================
...
-- Verificación: cada torneo del perfil trae su duración
select jsonb_pretty(competencias.perfil_publico('1a259364fcfbd57c')->'torneos');
